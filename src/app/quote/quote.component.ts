...
export class QuoteComponent implements OnInit {
  ...
  Quotes: Quote[] =[
    ...
    new Quote('Nature','I go to nature to be soothed and healed, and to have my senses put in order.','John Burroughs',1,0,'Terry',new Date(2019,4,15)),
  ...
  arr: number[]= this.Quotes.map(Quote1 => Quote.upVotes)
